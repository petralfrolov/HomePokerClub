...
export const S = {
  ...
  joinRequestTitle: 'Запрос на вход за стол',
  wantsJoin: 'хочет сесть за стол с байином',
  approvalQueue: (n: number) => `В очереди ещё: ${n}`,
  waitingForApproval: 'Ожидание одобрения администратора…',
  waitingForNextHand: 'Ожидание следующей руки…',
  joinDenied: 'Администратор отклонил вашу заявку на вход',
  allow: 'Разрешить?',
  no: 'Нет',
  yes: 'Да',
  ...
  send: 'Отправить',
  tipBtn: '💰 Типнуть',
  tipDisabledTooSmall: 'Недостаточно фишек для чаевых (нужно > 1 ББ)',
