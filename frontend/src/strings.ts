...
export const S = {
  ...
  shtosBtn: '🎴 Штос',
  shtosBlockBtn: '🚫 Запретить штос',
  shtosUnblockBtn: '✅ Разрешить штос',
  shtosTooSmallStack: 'Стеки слишком малы для штоса (нужно > 1 ББ у обоих)',
  shtosProposeTitle: 'Предложить штос',
  shtosProposeDescription: (name: string) =>
    `Предложить ${name} сыграть в штос. Победитель получит ставку с проигравшего.`,
  shtosBetLabel: 'Ставка',
  shtosPropose: 'Предложить',
  shtosOutgoingTitle: 'Ожидание ответа...',
  shtosOutgoingHint: (name: string) => `${name} получил предложение штоса. Ждём ответ.`,
  shtosIncomingTitle: '🎴 Вызов на штос!',
  shtosIncomingHint: (name: string, amount: number) =>
    `${name} предлагает сыграть в штос на ${amount}. После принятия вы оба автоматически фолдите текущую раздачу.`,
  shtosAccept: 'Принять',
  shtosDecline: 'Отказаться',
  shtosCancelOffer: 'Отменить',
  shtosTimerHint: 'Автоотмена через',
  shtosDeclineWarning: 'При отказе игрок будет автоматически заблокирован от новых предложений (можно снять в его профиле).',
  shtosCardPickTitleYou: 'Ваш ход — выберите карту',
  shtosCardPickTitleOther: (name: string) => `${name} выбирает карту...`,
  shtosCardPickHint: 'Выбранную карту мы будем ждать. На чью сторону она выпадет — тот и победил.',
  shtosAnimatingTitle: 'Игра в штос...',
  shtosAnimatingHint: (card: string) => `Ждём карту ${card}.`,
  shtosResultWin: (amount: number) => `🎉 Вы выиграли ${amount}!`,
  shtosResultLose: (amount: number) => `Вы проиграли ${amount}.`,
  shtosClose: 'Закрыть',
  shtosPickedCard: 'Загаданная карта',
  shtosPickerSide: 'Ваша сторона',
  shtosBankerSide: 'Сторона соперника',
  shtosUnblockedToast: (name: string) => `Разблокировано: ${name} снова может предлагать штос.`,
  shtosBlockedToast: (name: string) => `Заблокировано: ${name} больше не может предлагать штос.`,
